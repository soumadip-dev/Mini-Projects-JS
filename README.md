...
| <div align="center"><br>📝 **[Interactive Accordion](https://github.com/soumadip-dev/Mini-Projects-JS/tree/main/Interactive_Accordion)**<br>Expandable sections for better content organization.<br><br><img src="https://github.com/soumadip-dev/Mini-Projects-JS/blob/main/Interactive-Accordion/SS_Interactive_Accordion.png" width="220" height="140" style="border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"></div> |  |
